  ...
  const startKata = async () => {
    try {
      ...
      if (data) {
        ...
        poolAthletes[index].active_time = new Date()
          .toISOString()
          .slice(0, 19)
          .replace("T", " ");
      }
...
>
  ...
  <div class="container-fluid py-4">
    <div class="row mb-5">
      <div class="col">
        <p>
          <strong>current competition: </strong>:{competition.competition_name}
        </p>
      </div>
    </div>
    <div class="row mb-3">
      <small style="color: red;"
        >*** this button is to choose a pool at anytime to become the active
        pool</small
      ><br />
      <button
        class="btn btn-info btn-sm"
        data-bs-toggle="modal"
        data-bs-target="#activeModal">select active pool</button
      >
    </div>
    <div class="row mb-5">
      ...
      <div class="col-6 col-sm-3">
        <div class="form-group">
          ...
          <input
            class="form-control"
            type="text"
            value={`${activeAthlete.first_name || ""} ${
              activeAthlete.last_name || ""
            } `}
            disabled
          />
        </div>
      ...
      <div class="col-6 col-sm-3">
        <div class="form-group">
          ...
          <input
            class="form-control"
            type="text"
            value={`${nextAthlete.first_name || ""} ${
              nextAthlete.last_name || ""
            } `}
            disabled
          />
        </div>
    ...
    <div class="row mt-5">
      ...
      <div class="col-12 col-sm-4">
        <div on:click={nextAthleteBtn} class="button btn bg-secondary ">
          Next Athlete
        </div>
      </div>
    ...
    {#if closeModal}
      <p>
        showing result for: ${activeAthlete.first_name +
          " " +
          activeAthlete.last_name}
      </p>
    {/if}
...
<div
  ...
  id="activeModal"
  tabindex="-1"
  aria-labelledby="activeModalLabel"
  aria-hidden="true"
>
        ...
        <ul class="list-group">
          {#each pools as pool}
            <li
              ...
              class:active={pool.id == activePool.id}
